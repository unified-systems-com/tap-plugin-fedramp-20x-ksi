...
# Aggregated-verdict precedence for CITES_COMPLIANCE_EVIDENCE.support_kind values: any
...
def _build_rows(envelope: dict[str, Any], asset_id: str) -> list[dict[str, Any]]:
    ...
    for edge in envelope.get("edges", []):
        ...
        if et == "CARRIES_COMPLIANCE_FINDING__compliance_core" and from_id == asset_id and to_id in findings_by_id:
        ...
        elif et == "CITES_COMPLIANCE_EVIDENCE__compliance_core" and from_id in findings_by_id:
